#' @title Combine several \code{SingleCellExperiment} objects from different batches/experiments
#'
#' @description Combine several \code{SingleCellExperiment} objects from
#' different batches/experiments.
#' Extracted from the \href{https://bioconductor.org/packages/release/bioc/html/scMerge.html}{scMerge package}.
#'
